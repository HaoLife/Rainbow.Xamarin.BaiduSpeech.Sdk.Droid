...
namespace Com.Baidu.Speech.Asr {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']"
	[global::Android.Runtime.Register ("com/baidu/speech/asr/EventManagerAsr", DoNotGenerateAcw=true)]
	public partial class EventManagerAsr : global::Java.Lang.Object, global::Com.Baidu.Speech.IEventManager, global::Com.Baidu.Speech.Asr.IASRListener {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/baidu/speech/asr/EventManagerAsr", typeof (EventManagerAsr));
		...
		protected EventManagerAsr (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/constructor[@name='EventManagerAsr' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe EventManagerAsr (global::Android.Content.Context p0)
		...
		public static unsafe string SDKVersion {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/method[@name='getSDKVersion' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Com.Baidu.Speech.Asr.EventManagerAsr __this = global::Java.Lang.Object.GetObject<global::Com.Baidu.Speech.Asr.EventManagerAsr> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/method[@name='onEvent' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='byte[]'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/method[@name='registerListener' and count(parameter)=1 and parameter[1][@type='com.baidu.speech.EventListener']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/method[@name='send' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='byte[]'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.baidu.speech.asr']/class[@name='EventManagerAsr']/method[@name='unregisterListener' and count(parameter)=1 and parameter[1][@type='com.baidu.speech.EventListener']]"
